...
public class CustomerNewChatBoat extends AppCompatActivity {
            ...
            sendmsg.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (chatcontain.getText().toString().equals("") || (chatcontain.getText().toString().startsWith(" ") && chatcontain.getText().toString().endsWith(" "))) {
                        ...
                        final ProgressDialog progress = new ProgressDialog(CustomerNewChatBoat.this);
                        ...
                        if (SharedPrefManager.getInstance(CustomerNewChatBoat.this).getUser().getRole().equals("Customer")) {
                            ...
                            db.collection("CustomerHelp").document(cus_name + "," + cus_mob).set(chatboat).addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {
//                                String check=task.getResult().toString();
                                }
                            });
    ...
    private void snapshotlisten() {
        db.collection("CustomerChat").document(cus_name + "," + cus_mob).collection("Customermsg").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
    ...
    private void getchat() {
        db.collection("CustomerChat").document(cus_name + "," + cus_mob).collection("Customermsg").orderBy("Count", Query.Direction.DESCENDING).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    customerCHatAdapter = new
                            CustomerNewChatAdapter(CustomerNewChatBoat.this, eventList, db);
