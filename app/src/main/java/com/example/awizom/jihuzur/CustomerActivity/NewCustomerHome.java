...
import com.example.awizom.jihuzur.AdminActivity.SwipeControllerActions;
...
public class NewCustomerHome extends AppCompatActivity implements View.OnClickListener {
    ...
    private void getCategoryList() {
        ...
        try {
            ...
            adapterCategoryList = new CategoryListAdapter(NewCustomerHome.this, categorylist);
    ...
    public void showAddCategoryDialog(String categorynem, final String cetlogId, String cetlogName,String imgstr ) {
        ...
        buttonAddCategory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (validation()) {
                    progressDialog = new ProgressDialog(NewCustomerHome.this);
