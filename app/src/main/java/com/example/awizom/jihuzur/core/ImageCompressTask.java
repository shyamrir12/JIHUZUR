package com.example.awizom.jihuzur.core;
...
import com.example.awizom.jihuzur.listeners.IImageCompressTaskListener;
    ...
    public void run() {
        ...
        try {
            ...
            for (String path : originalPaths) {
                File file = com.example.awizom.jihuzur.Util.Util.getCompressed(mContext, path);
                //add it!
                result.add(file);
            }
